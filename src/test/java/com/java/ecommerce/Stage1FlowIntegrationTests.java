...
class Stage1FlowIntegrationTests {
    ...
    void stage1Flow_createCatalogCustomerCartAndCheckout() throws Exception {
        ...
        HttpResponse<String> categoryResponse = send("/api/categories", "POST", categoryJson, "admin", "admin123");
        ...
        BigDecimal totalAmount = new BigDecimal(JsonPath.read(checkoutResponse.body(), "$.totalAmount").toString());
    ...
    void adminEndpoints_areProtected() throws Exception {
        ...
        String createCustomerPayload = """
                ...
                """;
        HttpResponse<String> publicCreateAttempt = send("/api/customers", "POST", createCustomerPayload, null, null);
        assertEquals(401, publicCreateAttempt.statusCode());

        Long customerId = ensureCustomerExists("customer@example.com", "Portfolio Shopper");

        HttpResponse<String> customerListAsCustomer = send("/api/customers", "GET", null, "customer@example.com",
                "customer123");
    ...
    void customerCannotAccessAnotherCustomersCartOrOrders() throws Exception {
        ...
        String otherCustomerJson = """
                ...
                """.formatted(suffix);
        HttpResponse<String> otherResponse = send("/api/customers", "POST", otherCustomerJson, "admin", "admin123");
    ...
    private Long ensureCustomerExists(String email, String fullName) throws Exception {
        ...
        HttpResponse<String> createResponse = send("/api/customers", "POST", createCustomerJson, "admin", "admin123");
        assertEquals(201, createResponse.statusCode());
